...
def main(ip_address='192.168.0.10', port=10940, eps=eps, min_samples=min_samples, threshold_intensity_min=threshold_intensity_min, threshold_distance_dead=threshold_distance_dead):
